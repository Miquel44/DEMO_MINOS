...
GENERO_CHOICES = [('Mujer', 'Mujer'), ('Hombre', 'Hombre'), ('Unisex', 'Unisex')]
...
class PerfilEstiloForm(forms.ModelForm):
    ...
    class Meta:
        ...
        # Ahora sí funcionará porque las listas están definidas arriba del todo
        widgets = {
            ...
            'presupuesto_rango': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ej: 50-100€'}),
            'gustos_texto': forms.Textarea(attrs={'class': 'form-control', 'rows': 4, 'placeholder': 'Ej: Me gusta el estilo casual, odio el color amarillo...'}),
        }